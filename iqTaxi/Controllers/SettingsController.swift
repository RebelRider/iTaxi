...
class SettingsController: UITableViewController {
    ...
    func configureNavigationBar() {
        ...
        let image = UIImage(systemName: "rotate.3d")
        navigationItem.leftBarButtonItem = UIBarButtonItem(image: image!.withRenderingMode(.alwaysOriginal), style: .plain, target: self, action: #selector(handleDismissal))
    }
}
